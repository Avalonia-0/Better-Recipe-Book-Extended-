 ...
 * and without the real JEI runtime, regardless of the key binding saved in
 * options.txt.  While paused (Alt held) BRBE also steps the displayed variant
 * with Alt+wheel through {@link #manualIndexOverride} (>= 0 overrides the
 * automatic index; -1 = automatic).
 */
