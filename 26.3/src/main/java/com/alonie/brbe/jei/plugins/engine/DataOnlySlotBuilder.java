...
public final class DataOnlySlotBuilder implements IRecipeSlotBuilder {
    ...
    /** 26.3: {@code IRecipeSlotBuilder} 新增的"区域对齐"定位重载
     *  （{@code @since 30.32.0}）——无头场景只记录槽位坐标，对齐参数忽略。 */
    @Override
    public IRecipeSlotBuilder setPosition(int areaX, int areaY, int areaWidth, int areaHeight,
                                          mezz.jei.api.gui.placement.HorizontalAlignment horizontalAlignment,
                                          mezz.jei.api.gui.placement.VerticalAlignment verticalAlignment) {
        this.x = areaX;
        this.y = areaY;
        return this;
    }
