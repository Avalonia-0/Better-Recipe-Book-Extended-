        ...
        for (KeybindingField kb : FIELDS) {
            ...
            try {
                java.lang.reflect.Field field =
                        BetterRecipeBook.ctx().config().getClass().getDeclaredField(kb.fieldName());
                field.setAccessible(true);
                Object raw = field.get(BetterRecipeBook.ctx().config());
