...
/**
 * An {@link IDrawableBuilder} that records the drawable's size so the category
 * collector can identify the background it belongs to.  It still builds a
 * {@link RecordedDrawable} (a non-null, do-nothing drawable) so plugin category
 * constructors never NPE.
 */
